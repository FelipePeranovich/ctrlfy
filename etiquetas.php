        ...
        <nav class="navbar navbar-dark d-md-none" style="background-color: #1f252f;">
            ...
            <div class="collapse" id="mobileSidebar">
                <div class="sidebar-mobile p-5 align-items-center justify-content-center">
                    ...
                    <div class="mt-auto text-center">
                        <button class="btn btn-outline-light w-100 mt-5 ">
                            <i class="bi bi-box-arrow-left"></i> Sair
                        </button>
                        <?php
                        session_start();
        ...
        <div class="main-content flex-grow-1 p-4">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                <div class="input-group w-auto vendas-search">
                    ...
                    <input type="text" id="pesquisa" class="form-control" placeholder="Buscar etiquetas..." />
                </div>
            </div>
            ...
            if ($ordersResp['http_code'] === 200 && !empty($ordersResp['body']['results'])) {
                ...
                foreach ($ordersResp['body']['results'] as $order) {
                    ...
                    $firstTitle = $order['order_items'][0]['item']['title'] ?? '';
                    $imageUrl = null;
            ...
            <div class="etiqueta-card bg-white rounded shadow-sm p-3 mb-3"
                 data-item="<?=$firstItem?>"
                 data-title="<?=htmlspecialchars($firstTitle)?>"
                 data-id="<?=$id?>">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-end">
                        ...
                        <a target='_blank' href='https://www.mercadolivre.com.br/vendas/<?=$id?>/detalhe'>
                            <button class="btn-warning btn">Ver Venda</button>
                        </a>
                    </div>
                </div>
            </div>
